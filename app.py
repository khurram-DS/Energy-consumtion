...
def main():
    ...
    if choice == "About":
        ...
        st.markdown("""ACS is a consulting company specialized in data analysis was established during 2010.
Our mission is to clarify the right direction for business owners in order to get better business results 
using very advanced statistical approaches, also, to support postgraduate students to prove their finding 
using academic statistical analysis. Providing the work in a high level of quality is one of our important
goals. Our future vision is to be a leader in business analytics advisor for all successful business owners.
...
package in the GCC region, and that makes ACS more credible in statistical performance.""")
        ...
        st.write("""How do you use energy in your homes? 
            ...
            if st.checkbox("➡️ Analysis and statistics on different Spatial -Thermal comfort equipment (Air- conditioners)"):  
                ...
                if st.checkbox("Click here for Air conditioner device"):
                    ...
                    if st.checkbox("Table 2. Descriptive Statistics - Units owned of Air Conditioner"):
                        ...
                        acp.index = np.arange(1, len(acp) + 1)
                        st.table(acp)
                        ...
                        acs.index = np.arange(1, len(acs) + 1)
                        st.table(acs)
                        ...
                        acm.index = np.arange(1, len(acm) + 1)
                        st.table(acm)   
                        ...
                        acw.index = np.arange(1, len(acw) + 1)
                        st.table(acw)
                    ...
                    if st.checkbox("Table 3. Association of Air Conditioner (Units Owned) with Governorate"):
                        ...
                        #p-val
                        pval=new[['Governorate','#1 units owned - Air Conditioner Central Packaged ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#1 units owned - Air Conditioner Central Packaged ':'central_package'},inplace=True)
                        
                        
                        anova_students = ols('central_package~Governorate',data=pval).fit()
                        # examine the anova table 
                        anova_table_sm = sm.stats.anova_lm(anova_students, type=2)                                               
                        res=anova_table_sm
                        res.rename(columns={'PR(>F)':'P-val'},inplace=True)
                        df_res['P-value']=res['P-val'][0]
                    ...
                    #2     
                        ...
                        #p-val
                        pval=new[['Governorate','#1 units owned - Air Conditioner Central Split ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#1 units owned - Air Conditioner Central Split ':'central_split'},inplace=True)
                        
                        
                        anova_students = ols('central_split~Governorate',data=pval).fit()
                        # examine the anova table 
                        anova_table_sm = sm.stats.anova_lm(anova_students, type=2)                                               
                        res=anova_table_sm
                        res.rename(columns={'PR(>F)':'P-val'},inplace=True)
                        df_acs['P-value']=res['P-val'][0]
                        
                        df_acs.index = np.arange(1, len(df_acs) + 1) 
                        ...
                        #p-val
                        pval=new[['Governorate','#1 units owned - Air conditioning Units Mini split ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#1 units owned - Air conditioning Units Mini split ':'mini_split'},inplace=True)
                        
                        
                        anova_students = ols('mini_split~Governorate',data=pval).fit()
                        # examine the anova table 
                        anova_table_sm = sm.stats.anova_lm(anova_students, type=2)                                               
                        res=anova_table_sm
                        res.rename(columns={'PR(>F)':'P-val'},inplace=True)
                        df_ams['P-value']=res['P-val'][0]
                        
                        df_ams.index = np.arange(1, len(df_ams) + 1)  
                     ...
                     #4
                        ...
                        #p-val
                        pval=new[['Governorate','#1 units owned - Air conditioning Units Windows ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#1 units owned - Air conditioning Units Windows ':'Units_Windows'},inplace=True)
                        
                        
                        anova_students = ols('Units_Windows~Governorate',data=pval).fit()
                        # examine the anova table 
                        anova_table_sm = sm.stats.anova_lm(anova_students, type=2)                                               
                        res=anova_table_sm
                        res.rename(columns={'PR(>F)':'P-val'},inplace=True)
                        df_auw['P-value']=res['P-val'][0]
                        
                        df_auw.index = np.arange(1, len(df_auw) + 1) 
                    ...
                    if st.checkbox("Table4. Descriptive Statistics- Temperature of Air Conditioner"):
                        ...
                        atp.index = np.arange(1, len(atp) + 1) 
                        st.table(atp)
                        ...
                        atm.index = np.arange(1, len(atm) + 1) 
                        st.table(atm)   
                        ...
                        atw.index = np.arange(1, len(atw) + 1) 
                        st.table(atw)
                    ...
                    if st.checkbox("Table5. Association of Air Conditioner Average Temperature with Governorate"):
                        ...
                        #p-val
                        pval=new[['Governorate','#2 Average temperature (C) setting - Air Conditioner Central Packaged ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#2 Average temperature (C) setting - Air Conditioner Central Packaged ':'tac'},inplace=True)
                        
                        
                        anova_students = ols('tac~Governorate',data=pval).fit()
                        # examine the anova table 
                        anova_table_sm = sm.stats.anova_lm(anova_students, type=2)                                               
                        res=anova_table_sm
                        res.rename(columns={'PR(>F)':'P-val'},inplace=True)
                        df_atc['P-value']=res['P-val'][0]
                        
                        df_atc.index = np.arange(1, len(df_atc) + 1)  
                    ...
                    #2     
                        ...
                        del df_acs['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#2 Average temperature (C) setting - Air Conditioner Central Split ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#2 Average temperature (C) setting - Air Conditioner Central Split ':'tac'},inplace=True)
                        ...
                        del df_ams['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#2 Average temperature (C) setting - Air conditioning Units Mini split ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#2 Average temperature (C) setting - Air conditioning Units Mini split ':'tac'},inplace=True)
                     ...
                     #4
                        ...
                        del df_auw['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#2 Average temperature (C) setting - Air conditioning Units Windows ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#2 Average temperature (C) setting - Air conditioning Units Windows ':'tac'},inplace=True)
                ...
                #operating hours        
                    ...
                    if st.checkbox("Table 6. Descriptive Statistics- Operating Hours of Air Conditioner"):
                        ...
                        otp.index = np.arange(1, len(otp) + 1)
                        st.table(otp)
                    ...
                    if st.checkbox("Table 7. Association of Air Conditioner operating hours with Governorate"):
                        ...
                        del df_atc['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#3 Operating in hours per day - Air Conditioner Central Packaged ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#3 Operating in hours per day - Air Conditioner Central Packaged ':'tac'},inplace=True)
                    ...
                    #2     
                        ...
                        del df_acs['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#3 Operating in hours per day - Air Conditioner Central Split ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#3 Operating in hours per day - Air Conditioner Central Split ':'tac'},inplace=True)
                        ...
                        del df_ams['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#3 Operating in hours per day - Air conditioning Units Mini split ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#3 Operating in hours per day - Air conditioning Units Mini split ':'tac'},inplace=True)
                     ...
                     #4
                        ...
                        del df_auw['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#3 Operating in hours per day - Air conditioning Units Windows ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#3 Operating in hours per day - Air conditioning Units Windows ':'tac'},inplace=True)
                    ...
                    if st.checkbox("Table 8. Descriptive Statistics- Unit size of Air Conditioner"):
                        ...
                        aus.index = np.arange(1, len(aus) + 1)  
                        st.table(aus)
                    ...
                    if st.checkbox("Table 9. Association of Air Conditioner unit size with Governorate"):
                        ...
                        del df_atc['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#4 Unit size in Ton - Air Conditioner Central Packaged ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#4 Unit size in Ton - Air Conditioner Central Packaged ':'tac'},inplace=True)
                    ...
                    #2     
                        ...
                        del df_acs['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#4 Unit size in Ton - Air Conditioner Central Split ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#4 Unit size in Ton - Air Conditioner Central Split ':'tac'},inplace=True)
                        ...
                        del df_ams['Mubarak Al-Kabeer']
                         #p-val
                        pval=new[['Governorate','#4 Unit size in Ton - Air conditioning Units Mini split ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#4 Unit size in Ton - Air conditioning Units Mini split ':'tac'},inplace=True)
                     ...
                     #4
                        ...
                        del df_auw['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#4 Unit size in Ton - Air conditioning Units Windows ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#4 Unit size in Ton - Air conditioning Units Windows ':'tac'},inplace=True)
                    ...
                    if st.checkbox("Table 10. Descriptive Statistics- Watt consumed by Air Conditioner"):
                        ...
                        wac.index = np.arange(1, len(wac) + 1) 
                        st.table(wac)
                    ...
                    if st.checkbox("Table 11. Association of watt consumed by Air Conditioner with Governorate"):
                        ...
                        del df_atc['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','Air Conditioner Central Packaged  - The estimated Watts consumed per day']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'Air Conditioner Central Packaged  - The estimated Watts consumed per day':'tac'},inplace=True)
                    ...
                    #2     
                        ...
                        del df_acs['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','Air Conditioner Central Split  - The estimated Watts consumed per day']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'Air Conditioner Central Split  - The estimated Watts consumed per day':'tac'},inplace=True)
                        ...
                        del df_ams['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','Air conditioning Units Mini split  - The estimated Watts consumed per day']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'Air conditioning Units Mini split  - The estimated Watts consumed per day':'tac'},inplace=True)
                     ...
                     #4
                        ...
                        del df_auw['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','Air conditioning Units Windows  - The estimated Watts consumed per day']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'Air conditioning Units Windows  - The estimated Watts consumed per day':'tac'},inplace=True)
                ...
                if st.checkbox("Table 13. Association of consumption by Portable air cooler for single room"):
                    ...
                    del df_atc['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','#1 units owned - Portable air cooler for single room']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'#1 units owned - Portable air cooler for single room':'tac'},inplace=True)
                    ...
                    del df_acs['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','#2 Average temperature (C) setting - Portable air cooler for single room']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'#2 Average temperature (C) setting - Portable air cooler for single room':'tac'},inplace=True)
                    ...
                    del df_ams['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','#3 Operating in hours per day - Portable air cooler for single room']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'#3 Operating in hours per day - Portable air cooler for single room':'tac'},inplace=True)
                    ...
                    del df_auw['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','Portable air cooler for single room - The estimated Watts consumed per day']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'Portable air cooler for single room - The estimated Watts consumed per day':'tac'},inplace=True)
                ...
                if st.checkbox("Table 15. Association of consumption by Air Purifier Device"):
                    ...
                    del df_atc['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','#1 units owned - Air Purifier Device']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'#1 units owned - Air Purifier Device':'tac'},inplace=True)
                    ...
                    del df_ams['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','#2 Operating in hours per day - Air Purifier Device']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'#2 Operating in hours per day - Air Purifier Device':'tac'},inplace=True)
                    ...
                    del df_auw['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','Air Purifier Device - The estimated Watts consumed per day']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'Air Purifier Device - The estimated Watts consumed per day':'tac'},inplace=True)
                ...
                if st.checkbox("Table 17. Association of consumtion by Electric fan"):
                    ...
                    del df_atc['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','#1 units owned - Electric fan']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'#1 units owned - Electric fan':'tac'},inplace=True)
                    ...
                    del df_ams['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','#2 Operating in hours per day - Electric fan']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'#2 Operating in hours per day - Electric fan':'tac'},inplace=True)
                    ...
                    del df_auw['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','Electric fan - The estimated Watts consumed per day']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'Electric fan - The estimated Watts consumed per day':'tac'},inplace=True)
                ...
                if st.checkbox("Click here for Heater Equipments"):
                    ...
                    if st.checkbox("Table 19. Association of units owned by (Heater)"):
                        ...
                        del df_atc['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#1 units owned - Heater - Central ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#1 units owned - Heater - Central ':'tac'},inplace=True)
                    ...
                    #2     
                        ...
                        del df_acs['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#1 units owned - Heater - Space Heater (Portable, Electric) ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#1 units owned - Heater - Space Heater (Portable, Electric) ':'tac'},inplace=True)
                        ...
                        del df_ams['Mubarak Al-Kabeer']
                         #p-val
                        pval=new[['Governorate','#1 units owned - Heater - Space Heater (Portable, Oil) ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#1 units owned - Heater - Space Heater (Portable, Oil) ':'tac'},inplace=True)
                    ...
                    if st.checkbox("Table 21. Association of Operating in hours per day by (Heater)"):
                        ...
                        del df_atc['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#2 Operating in hours per day - Heater - Central ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#2 Operating in hours per day - Heater - Central ':'tac'},inplace=True)
                    ...
                    #2     
                        ...
                        del df_acs['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#2 Operating in hours per day - Heater - Space Heater (Portable, Electric) ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#2 Operating in hours per day - Heater - Space Heater (Portable, Electric) ':'tac'},inplace=True)
                        ...
                        del df_ams['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#2 Operating in hours per day - Heater - Space Heater (Portable, Oil) ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#2 Operating in hours per day - Heater - Space Heater (Portable, Oil) ':'tac'},inplace=True)
                    ...
                    if st.checkbox("Table 23. Association of Watts consumed per day by (Heater)"):
                        ...
                        del df_atc['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','Heater - Central  - The estimated Watts consumed per day']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'Heater - Central  - The estimated Watts consumed per day':'tac'},inplace=True)
                    ...
                    #2     
                        ...
                        del df_acs['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','Heater - Space Heater (Portable, Electric)  - The estimated Watts consumed per day']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'Heater - Space Heater (Portable, Electric)  - The estimated Watts consumed per day':'tac'},inplace=True)
                        ...
                        del df_ams['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','Heater - Space Heater (Portable, Oil)  - The estimated Watts consumed per day']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'Heater - Space Heater (Portable, Oil)  - The estimated Watts consumed per day':'tac'},inplace=True)
            ...
            if st.checkbox("➡️ Analysis and statistics on different Cooking Equipments / Kitchen Equipments"):
                ...
                if st.checkbox("Click here for Cooking / Kitchen Equipments"):
                    ...
                    if st.checkbox("Table 24. Descriptive Statistics- Kitchen items (Units owned)"):
                        ...
                        atre.index = np.arange(1, len(atre) + 1)
                        st.table(atre)
                        ...
                        acook.index = np.arange(1, len(acook) + 1)
                        st.table(acook)
                        ...
                        ale.index = np.arange(1, len(ale) + 1)
                        st.table(ale)
                    ...
                    if st.checkbox("Table 25. Association of units owned by Kitchen items"):
                        ...
                        del df_atc['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#1 units owned - Blender/mixer/food processor ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#1 units owned - Blender/mixer/food processor ':'tac'},inplace=True)
                    ...
                    #2     
                        ...
                        del df_acs['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#1 units owned - kettle ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#1 units owned - kettle ':'tac'},inplace=True)
...
#3
                        ...
                        del df_ams['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#1 units owned - Toaster ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#1 units owned - Toaster ':'tac'},inplace=True)
                     ...
                     #4
                        ...
                        del df_auw['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#1 units owned - Range - LPG ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#1 units owned - Range - LPG ':'tac'},inplace=True)
                      ...
                      #5  
                        ...
                        del df_auw['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#1 units owned - Range - Electric ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#1 units owned - Range - Electric ':'tac'},inplace=True)
                      ...
                      #6  
                        ...
                        #p-val
                        pval=new[['Governorate','#1 units owned - Cooktop - (LPG/Electric/Induction) ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#1 units owned - Cooktop - (LPG/Electric/Induction) ':'tac'},inplace=True)
                        ...
                        res=anova_table_sm
                        res.rename(columns={'PR(>F)':'P-val'},inplace=True)
                        df_cokt['P-value']=res['P-val'][0]

                        df_cokt.index = np.arange(1, len(df_cokt) + 1) 
...
#7
                        ...
                        #p-val
                        pval=new[['Governorate','#1 units owned - Oven -(LPG/Electric) ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#1 units owned - Oven -(LPG/Electric) ':'tac'},inplace=True)
                        ...
                        res=anova_table_sm
                        res.rename(columns={'PR(>F)':'P-val'},inplace=True)
                        df_lpg['P-value']=res['P-val'][0]

                        df_lpg.index = np.arange(1, len(df_lpg) + 1) 
                        ...
                        #p-val
                        pval=new[['Governorate','#1 units owned - Air fryer ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#1 units owned - Air fryer ':'tac'},inplace=True)
                        ...
                        res=anova_table_sm
                        res.rename(columns={'PR(>F)':'P-val'},inplace=True)
                        df_af['P-value']=res['P-val'][0]

                        df_af.index = np.arange(1, len(df_af) + 1) 
                        ...
                        #p-val
                        pval=new[['Governorate','#1 units owned - Coffee Maker ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#1 units owned - Coffee Maker ':'tac'},inplace=True)
                        ...
                        res=anova_table_sm
                        res.rename(columns={'PR(>F)':'P-val'},inplace=True)
                        df_cm['P-value']=res['P-val'][0]

                        df_cm.index = np.arange(1, len(df_cm) + 1) 
                    ...
                    if st.checkbox("Table 27. Association of Operating in minutes per day of Kitchen items"):
                        ...
                        del df_atc['Mubarak Al-Kabeer']
                         #p-val
                        pval=new[['Governorate','#2 Operating in minutes per day - Blender/mixer/food processor ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#2 Operating in minutes per day - Blender/mixer/food processor ':'tac'},inplace=True)
                    ...
                    #2     
                        ...
                        del df_acs['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#2 Operating in minutes per day - kettle ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#2 Operating in minutes per day - kettle ':'tac'},inplace=True)
                        ...
                        del df_ams['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#2 Operating in minutes per day - Toaster ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#2 Operating in minutes per day - Toaster ':'tac'},inplace=True)
                     ...
                     #4
                        ...
                        del df_auw['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#2 Operating in minutes per day - Range - LPG ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#2 Operating in minutes per day - Range - LPG ':'tac'},inplace=True)
                      ...
                      #5  
                        ...
                        del df_auw['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#2 Operating in minutes per day - Range - Electric ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#2 Operating in minutes per day - Range - Electric ':'tac'},inplace=True)
                      ...
                      #6  
                        ...
                        del df_cokt['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#2 Operating in minutes per day - Cooktop - (LPG/Electric/Induction) ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#2 Operating in minutes per day - Cooktop - (LPG/Electric/Induction) ':'tac'},inplace=True)
                        ...
                        del df_lpg['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#2 Operating in minutes per day - Oven -(LPG/Electric) ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#2 Operating in minutes per day - Oven -(LPG/Electric) ':'tac'},inplace=True)
                        ...
                        del df_af['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#2 Operating in minutes per day - Air fryer ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#2 Operating in minutes per day - Air fryer ':'tac'},inplace=True)
                        ...
                        del df_cm['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','#2 Operating in minutes per day - Coffee Maker ']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'#2 Operating in minutes per day - Coffee Maker ':'tac'},inplace=True)
                    ...
                    if st.checkbox("Table 29. Association of The estimated Watts consumed per day of Kitchen items"):
                        ...
                        del df_atc['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','Blender/mixer/food processor  - The estimated Watts consumed per day']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'Blender/mixer/food processor  - The estimated Watts consumed per day':'tac'},inplace=True)
                    ...
                    #2     
                        ...
                        del df_acs['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','kettle- The estimated Watts consumed per day']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'kettle- The estimated Watts consumed per day':'tac'},inplace=True)
                        ...
                        del df_ams['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','Toaster- The estimated Watts consumed per day']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'Toaster- The estimated Watts consumed per day':'tac'},inplace=True)
                     ...
                     #4
                        ...
                        del df_auw['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','Range - LPG- The estimated Watts consumed per day']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'Range - LPG- The estimated Watts consumed per day':'tac'},inplace=True)
                      ...
                      #5  
                        ...
                        del df_auw['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','Range - Electric- The estimated Watts consumed per day']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'Range - Electric- The estimated Watts consumed per day':'tac'},inplace=True)
                      ...
                      #6  
                        ...
                        del df_cokt['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','Cooktop - (LPG/Electric/Induction)- The estimated Watts consumed per day']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'Cooktop - (LPG/Electric/Induction)- The estimated Watts consumed per day':'tac'},inplace=True)
                        ...
                        del df_lpg['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','Oven -(LPG/Electric)- The estimated Watts consumed per day']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'Oven -(LPG/Electric)- The estimated Watts consumed per day':'tac'},inplace=True)
                        ...
                        del df_af['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','Air fryer- The estimated Watts consumed per day']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'Air fryer- The estimated Watts consumed per day':'tac'},inplace=True)
                        ...
                        del df_cm['Mubarak Al-Kabeer']
                        #p-val
                        pval=new[['Governorate','Coffee Maker- The estimated Watts consumed per day']]
                        pval.reset_index(inplace = True)
                        pval.rename(columns={'Coffee Maker- The estimated Watts consumed per day':'tac'},inplace=True)
            ...
            if st.checkbox("➡️ Analysis and statistics on different Water equipment"):
                ...
                if st.checkbox("Table 31. Association of Units owned (Water equipment)"):
                    ...
                    del df_atc['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','#1 units owned - Water Cooler  ']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'#1 units owned - Water Cooler  ':'tac'},inplace=True)
                ...
                #2     
                    ...
                    del df_acs['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','#1 units owned - Water Heater - Central  ']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'#1 units owned - Water Heater - Central  ':'tac'},inplace=True)
                    ...
                    #p-val
                    pval=new[['Governorate','#1 units owned - Water Heater - Normal  ']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'#1 units owned - Water Heater - Normal  ':'tac'},inplace=True)
                ...
                if st.checkbox("Table 33. Association of size of the equipment (Water)"):
                    ...
                    del df_atc['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','#2 What is the size of the equipment? (e.g. 10 litres, 15 litres) - Water Cooler']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'#2 What is the size of the equipment? (e.g. 10 litres, 15 litres) - Water Cooler':'tac'},inplace=True)
                ...
                #2     
                    ...
                    del df_acs['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','#2 What is the size of the equipment? (e.g. 10 litres, 15 litres) - Water Heater - Central']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'#2 What is the size of the equipment? (e.g. 10 litres, 15 litres) - Water Heater - Central':'tac'},inplace=True)
                    ...
                    del df_ams['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','#2 What is the size of the equipment? (e.g. 10 litres, 15 litres) - Water Heater - Normal']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'#2 What is the size of the equipment? (e.g. 10 litres, 15 litres) - Water Heater - Normal':'tac'},inplace=True)
                ...
                if st.checkbox("Table 35. Association of The estimated Watts consumed per day (Water)"):
                    ...
                    del df_atc['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','Water Cooler - The estimated Watts consumed per day']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'Water Cooler - The estimated Watts consumed per day':'tac'},inplace=True)
                ...
                #2     
                    ...
                    del df_acs['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','Water Heater - Central - The estimated Watts consumed per day']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'Water Heater - Central - The estimated Watts consumed per day':'tac'},inplace=True)
                    ...
                    del df_ams['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','Water Heater - Normal - The estimated Watts consumed per day']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'Water Heater - Normal - The estimated Watts consumed per day':'tac'},inplace=True)
            ...
            if st.checkbox("➡️ Analysis and statistics on Miscellaneous equipment"):
                ...
                if st.checkbox("Table 37. Association of units owned of (Miscellaneous equipment)"):
                    ...
                    del df_atc['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','#1 units owned - Clothes dryer  ']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'#1 units owned - Clothes dryer  ':'tac'},inplace=True)
                ...
                #2     
                    ...
                    del df_acs['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','#1 units owned - Front loaded Clothes washer automatic  ']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'#1 units owned - Front loaded Clothes washer automatic  ':'tac'},inplace=True)
    ...
    #3
                    ...
                    del df_ams['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','#1 units owned - Top loaded Clothes washer automatic  ']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'#1 units owned - Top loaded Clothes washer automatic  ':'tac'},inplace=True)
                 ...
                 #4
                    ...
                    del df_auw['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','#1 units owned - Clothes washer normal  ']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'#1 units owned - Clothes washer normal  ':'tac'},inplace=True)
                  ...
                  #5  
                    ...
                    del df_auw['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','#1 units owned - Dish washer  ']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'#1 units owned - Dish washer  ':'tac'},inplace=True)
                  ...
                  #6  
                    ...
                    del df_cokt['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','#1 units owned - Freezer  ']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'#1 units owned - Freezer  ':'tac'},inplace=True)
    ...
    #7
                    ...
                    del df_lpg['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','#1 units owned - Refrigerator  ']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'#1 units owned - Refrigerator  ':'tac'},inplace=True)
                ...
                if st.checkbox("Table 39. Association of No of times appliance used in a week of (Miscellaneous equipment)"):
                    ...
                    del df_atc['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','#2 How many times do you use this appliance in a week? (5 times, 6 times or daily) - Clothes dryer']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'#2 How many times do you use this appliance in a week? (5 times, 6 times or daily) - Clothes dryer':'tac'},inplace=True)
                ...
                #2     
                    ...
                    del df_acs['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','#2 How many times do you use this appliance in a week? (5 times, 6 times or daily) - Front loaded Clothes washer automatic']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'#2 How many times do you use this appliance in a week? (5 times, 6 times or daily) - Front loaded Clothes washer automatic':'tac'},inplace=True)
    ...
    #3
                    ...
                    del df_ams['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','#2 How many times do you use this appliance in a week? (5 times, 6 times or daily) - Top loaded Clothes washer automatic']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'#2 How many times do you use this appliance in a week? (5 times, 6 times or daily) - Top loaded Clothes washer automatic':'tac'},inplace=True)
                 ...
                 #4
                    ...
                    del df_auw['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','#2 How many times do you use this appliance in a week? (5 times, 6 times or daily) - Clothes washer normal']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'#2 How many times do you use this appliance in a week? (5 times, 6 times or daily) - Clothes washer normal':'tac'},inplace=True)
                  ...
                  #5  
                    ...
                    del df_auw['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','#2 How many times do you use this appliance in a week? (5 times, 6 times or daily) - Dish washer']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'#2 How many times do you use this appliance in a week? (5 times, 6 times or daily) - Dish washer':'tac'},inplace=True)
                ...
                if st.checkbox("Table 41. Association of Watts consumed of (Miscellaneous equipment)"):
                    ...
                    del df_atc['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','Clothes dryer - The estimated Watts consumed per day']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'Clothes dryer - The estimated Watts consumed per day':'tac'},inplace=True)
                ...
                #2     
                    ...
                    del df_acs['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','Front loaded Clothes washer automatic - The estimated Watts consumed per day']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'Front loaded Clothes washer automatic - The estimated Watts consumed per day':'tac'},inplace=True)
    ...
    #3
                    ...
                    #p-val
                    pval=new[['Governorate','Top loaded Clothes washer automatic - The estimated Watts consumed per day']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'Top loaded Clothes washer automatic - The estimated Watts consumed per day':'tac'},inplace=True)
                 ...
                 #4
                    ...
                    del df_auw['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','Clothes washer normal - The estimated Watts consumed per day']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'Clothes washer normal - The estimated Watts consumed per day':'tac'},inplace=True)
                  ...
                  #5  
                    ...
                    del df_auw['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','Dish washer - The estimated Watts consumed per day']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'Dish washer - The estimated Watts consumed per day':'tac'},inplace=True)
                  ...
                  #6  
                    ...
                    del df_cokt['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','Freezer - The estimated Watts consumed per day']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'Freezer - The estimated Watts consumed per day':'tac'},inplace=True)
    ...
    #7
                    ...
                    del df_lpg['Mubarak Al-Kabeer']
                    #p-val
                    pval=new[['Governorate','Refrigerator - The estimated Watts consumed per day']]
                    pval.reset_index(inplace = True)
                    pval.rename(columns={'Refrigerator - The estimated Watts consumed per day':'tac'},inplace=True)
            ...
            st.subheader("Analysis on Other Electronics / Miscellaneous / Lighting equipment")
            if st.checkbox("➡️ Analysis and statistics on electronic / Miscellaneous / Lighting equipment"):
                dict =  {'Type a question >> الكمبيوتر - سطح المكتب / الكل في واحد >> كم لديك من هؤلاء؟ (يرجى تحديد الأرقام)\t' : 'No of Computer - Desktop/All-in-One',
        'Type a question >> كمبيوتر - لاب توب / 2 في واحد / تابلت >> كم لديك من هؤلاء؟ (يرجى تحديد الأرقام)\t': 'No of Computer - Laptop / 2-in-1 / Tablet',
        'Type a question >> كاميرا الأمن / مودم / راوتر واي فاي >> كم لديك من هؤلاء؟ (يرجى تحديد الأرقام)\t': 'No of Security Camera/Modem/Wi-Fi Router',
       'Type a question >> ستيريو / راديو / مكبرات صوت >> كم لديك من هؤلاء؟ (يرجى تحديد الأرقام)\t': 'No of Stereo/Radio/Speakers',
       'Type a question >> مسرح منزلي للعرض المرئي  >> كم لديك من هؤلاء؟ (يرجى تحديد الأرقام)\t': 'No of Home Theater',
       'Type a question >> جهاز العاب الفيديو >> كم لديك من هؤلاء؟ (يرجى تحديد الأرقام)\t': 'No of Gaming Console',
       'Type a question >> طابعة / ماسح ضوئي / ناسخة >> كم لديك من هؤلاء؟ (يرجى تحديد الأرقام)\t': 'No of Printer/Scanner/Copier',
       'Type a question >> تلفزيون LED / OLED / QLED / بلازما / النوع القديم >> كم لديك من هؤلاء؟ (يرجى تحديد الأرقام)\t': 'No of LED / OLED / QLED / Plasma / Old Type TV',
       'ما هي المعدات المتنوعة التي لديك؟ >> مجفف شعر, مموج الشعر, او مكواة شعر مسطحة >> كم لديك من هؤلاء؟': 'No of Hairdryer, hair curler, or flat iron',
       'ما هي المعدات المتنوعة التي لديك؟ >> جهاز استقبال أطباق الأقمار الصناعية >> كم لديك من هؤلاء؟': 'No of Satellite dish receiver',
       'ما هي المعدات المتنوعة التي لديك؟ >> مكنسة كهربائية >> كم لديك من هؤلاء؟': 'No of Vacuum cleaner',
       'ما هي المعدات المتنوعة التي لديك؟ >> حديد كهربائي >> كم لديك من هؤلاء؟': 'No of Electric iron',
        'Type a question >> ساطع >> ما هو عدد المصابيح؟ (على سبيل المثال 12 أو 15 لمبة)':'No of Incandescent',
        'Type a question >> LED >> ما هو عدد المصابيح؟ (على سبيل المثال 12 أو 15 لمبة)':'No of LEDs',
        'Type a question >> الهالوجين >> ما هو عدد المصابيح؟ (على سبيل المثال 12 أو 15 لمبة)':'No of Halogen',
        'Type a question >> CFL / الفلورسنت >> ما هو عدد المصابيح؟ (على سبيل المثال 12 أو 15 لمبة)':'No of CFL/Fluorescent',
        
       }
                frequ=new.copy()
                frequ.rename(columns=dict,inplace=True)
            
                if st.checkbox("Table 42. Demographic Variables for other Electronics equipments"):
                    
                    st.markdown('**Computer - Desktop/All-in-One**')                    
                    ss =pd.DataFrame(frequ.groupby('Governorate')['No of Computer - Desktop/All-in-One'].count())
                    ss['%'] = (100 * ss['No of Computer - Desktop/All-in-One']  / ss['No of Computer - Desktop/All-in-One'].sum()).round(1).astype(str) + '%'
                    n=ss['No of Computer - Desktop/All-in-One'].sum()
                    ss.rename(columns={'No of Computer - Desktop/All-in-One':'No of Computer - Desktop/All-in-One (N={})'.format(n)},inplace=True)
                    ss=ss.sort_values(by=['No of Computer - Desktop/All-in-One (N={})'.format(n)], ascending=False)
                    st.table(ss)
                
                    st.markdown('**Computer - Laptop / 2-in-1 / Tablet**')                    
                    ss1 =pd.DataFrame(frequ.groupby('Governorate')['No of Computer - Laptop / 2-in-1 / Tablet'].count())
                    ss1['%'] = (100 * ss1['No of Computer - Laptop / 2-in-1 / Tablet']  / ss1['No of Computer - Laptop / 2-in-1 / Tablet'].sum()).round(1).astype(str) + '%'
                    n=ss1['No of Computer - Laptop / 2-in-1 / Tablet'].sum()
                    ss1.rename(columns={'No of Computer - Laptop / 2-in-1 / Tablet':'No of Computer - Laptop / 2-in-1 / Tablet (N={})'.format(n)},inplace=True)
                    ss1=ss1.sort_values(by=['No of Computer - Laptop / 2-in-1 / Tablet (N={})'.format(n)], ascending=False)
                    st.table(ss1)
                    
                    st.markdown('**Security Camera/Modem/Wi-Fi Router**')                    
                    ss2 =pd.DataFrame(frequ.groupby('Governorate')['No of Security Camera/Modem/Wi-Fi Router'].count())
                    ss2['%'] = (100 * ss2['No of Security Camera/Modem/Wi-Fi Router']  / ss2['No of Security Camera/Modem/Wi-Fi Router'].sum()).round(1).astype(str) + '%'
                    n=ss2['No of Security Camera/Modem/Wi-Fi Router'].sum()
                    ss2.rename(columns={'No of Security Camera/Modem/Wi-Fi Router':'No of Security Camera/Modem/Wi-Fi Router (N={})'.format(n)},inplace=True)
                    ss2=ss2.sort_values(by=['No of Security Camera/Modem/Wi-Fi Router (N={})'.format(n)], ascending=False)
                    st.table(ss2)
                    
                    st.markdown('**Stereo/Radio/Speakers**')                    
                    ss3 =pd.DataFrame(frequ.groupby('Governorate')['No of Stereo/Radio/Speakers'].count())
                    ss3['%'] = (100 * ss3['No of Stereo/Radio/Speakers']  / ss3['No of Stereo/Radio/Speakers'].sum()).round(1).astype(str) + '%'
                    n=ss3['No of Stereo/Radio/Speakers'].sum()
                    ss3.rename(columns={'No of Stereo/Radio/Speakers':'No of Stereo/Radio/Speakers (N={})'.format(n)},inplace=True)
                    ss3=ss3.sort_values(by=['No of Stereo/Radio/Speakers (N={})'.format(n)], ascending=False)
                    st.table(ss3)
                    
                    st.markdown('**Home Theater**')                    
                    ss4 =pd.DataFrame(frequ.groupby('Governorate')['No of Home Theater'].count())
                    ss4['%'] = (100 * ss4['No of Home Theater']  / ss4['No of Home Theater'].sum()).round(1).astype(str) + '%'
                    n=ss4['No of Home Theater'].sum()
                    ss4.rename(columns={'No of Home Theater':'No of Home Theater (N={})'.format(n)},inplace=True)
                    ss4=ss4.sort_values(by=['No of Home Theater (N={})'.format(n)], ascending=False)
                    st.table(ss4)
                    
                    st.markdown('**Gaming Console**')                    
                    ss5 =pd.DataFrame(frequ.groupby('Governorate')['No of Gaming Console'].count())
                    ss5['%'] = (100 * ss5['No of Gaming Console']  / ss5['No of Gaming Console'].sum()).round(1).astype(str) + '%'
                    n=ss5['No of Gaming Console'].sum()
                    ss5.rename(columns={'No of Gaming Console':'No of Gaming Console (N={})'.format(n)},inplace=True)
                    ss5=ss5.sort_values(by=['No of Gaming Console (N={})'.format(n)], ascending=False)
                    st.table(ss5)
                    
                    st.markdown('**Printer/Scanner/Copier**')                    
                    ss6 =pd.DataFrame(frequ.groupby('Governorate')['No of Printer/Scanner/Copier'].count())
                    ss6['%'] = (100 * ss6['No of Printer/Scanner/Copier']  / ss6['No of Printer/Scanner/Copier'].sum()).round(1).astype(str) + '%'
                    n=ss6['No of Printer/Scanner/Copier'].sum()
                    ss6.rename(columns={'No of Printer/Scanner/Copier':'No of Printer/Scanner/Copier (N={})'.format(n)},inplace=True)
                    ss6=ss6.sort_values(by=['No of Printer/Scanner/Copier (N={})'.format(n)], ascending=False)
                    st.table(ss6)
                    
                    st.markdown('**LED / OLED / QLED / Plasma / Old Type TV**')                    
                    ss7 =pd.DataFrame(frequ.groupby('Governorate')['No of LED / OLED / QLED / Plasma / Old Type TV'].count())
                    ss7['%'] = (100 * ss7['No of LED / OLED / QLED / Plasma / Old Type TV']  / ss7['No of LED / OLED / QLED / Plasma / Old Type TV'].sum()).round(1).astype(str) + '%'
                    n=ss7['No of LED / OLED / QLED / Plasma / Old Type TV'].sum()
                    ss7.rename(columns={'No of LED / OLED / QLED / Plasma / Old Type TV':'No of LED / OLED / QLED / Plasma / Old Type TV (N={})'.format(n)},inplace=True)
                    ss7=ss7.sort_values(by=['No of LED / OLED / QLED / Plasma / Old Type TV (N={})'.format(n)], ascending=False)
                    st.table(ss7)
                    
                if st.checkbox("Table 43. Demographic Variables for miscellaneous equipments"):
                    
                    st.markdown('**Hairdryer, hair curler, or flat iron**')                    
                    hh1 =pd.DataFrame(frequ.groupby('Governorate')['No of Hairdryer, hair curler, or flat iron'].count())
                    hh1['%'] = (100 * hh1['No of Hairdryer, hair curler, or flat iron']  / hh1['No of Hairdryer, hair curler, or flat iron'].sum()).round(1).astype(str) + '%'
                    n=hh1['No of Hairdryer, hair curler, or flat iron'].sum()
                    hh1.rename(columns={'No of Hairdryer, hair curler, or flat iron':'No of Hairdryer, hair curler, or flat iron  (N={})'.format(n)},inplace=True)
                    hh1=hh1.sort_values(by=['No of Hairdryer, hair curler, or flat iron  (N={})'.format(n)], ascending=False)
                    st.table(hh1)
                    
                    st.markdown('**Satellite dish receiver**')                    
                    hh2 =pd.DataFrame(frequ.groupby('Governorate')['No of Satellite dish receiver'].count())
                    hh2['%'] = (100 * hh2['No of Satellite dish receiver']  / hh2['No of Satellite dish receiver'].sum()).round(1).astype(str) + '%'
                    n=hh2['No of Satellite dish receiver'].sum()
                    hh2.rename(columns={'No of Satellite dish receiver':'No of Satellite dish receiver  (N={})'.format(n)},inplace=True)
                    hh2=hh2.sort_values(by=['No of Satellite dish receiver  (N={})'.format(n)], ascending=False)
                    st.table(hh2)
                    
                    st.markdown('**Vacuum cleaner**')                    
                    hh3 =pd.DataFrame(frequ.groupby('Governorate')['No of Vacuum cleaner'].count())
                    hh3['%'] = (100 * hh3['No of Vacuum cleaner']  / hh3['No of Vacuum cleaner'].sum()).round(1).astype(str) + '%'
                    n=hh3['No of Vacuum cleaner'].sum()
                    hh3.rename(columns={'No of Vacuum cleaner':'No of Vacuum cleaner  (N={})'.format(n)},inplace=True)
                    hh3=hh3.sort_values(by=['No of Vacuum cleaner  (N={})'.format(n)], ascending=False)
                    st.table(hh3)
                    
                    st.markdown('**Electric iron**')                    
                    hh5 =pd.DataFrame(frequ.groupby('Governorate')['No of Electric iron'].count())
                    hh5['%'] = (100 * hh5['No of Electric iron']  / hh5['No of Electric iron'].sum()).round(1).astype(str) + '%'
                    n=hh5['No of Electric iron'].sum()
                    hh5.rename(columns={'No of Electric iron':'No of Electric iron  (N={})'.format(n)},inplace=True)
                    hh5=hh5.sort_values(by=['No of Electric iron  (N={})'.format(n)], ascending=False)
                    st.table(hh5)
                if st.checkbox("Table 44. Demographic Variables for Lighting equipments"):
                    
                    st.markdown('**Incandescent**')                    
                    ll1 =pd.DataFrame(frequ.groupby('Governorate')['No of Incandescent'].count())
                    ll1['%'] = (100 * ll1['No of Incandescent']  / ll1['No of Incandescent'].sum()).round(1).astype(str) + '%'
                    n=ll1['No of Incandescent'].sum()
                    ll1.rename(columns={'No of Incandescent':'No of Incandescent  (N={})'.format(n)},inplace=True)
                    ll1=ll1.sort_values(by=['No of Incandescent  (N={})'.format(n)], ascending=False)
                    st.table(ll1)
                    
                    st.markdown('**LEDs**')                    
                    ll2 =pd.DataFrame(frequ.groupby('Governorate')['No of LEDs'].count())
                    ll2['%'] = (100 * ll2['No of LEDs']  / ll2['No of LEDs'].sum()).round(1).astype(str) + '%'
                    n=ll2['No of LEDs'].sum()
                    ll2.rename(columns={'No of LEDs':'No of LEDs  (N={})'.format(n)},inplace=True)
                    ll2=ll2.sort_values(by=['No of LEDs  (N={})'.format(n)], ascending=False)
                    st.table(ll2)
                    
                    st.markdown('**Halogen**')                    
                    ll3 =pd.DataFrame(frequ.groupby('Governorate')['No of Halogen'].count())
                    ll3['%'] = (100 * ll3['No of Halogen']  / ll3['No of Halogen'].sum()).round(1).astype(str) + '%'
                    n=ll3['No of Halogen'].sum()
                    ll3.rename(columns={'No of Halogen':'No of Halogen  (N={})'.format(n)},inplace=True)
                    ll3=ll3.sort_values(by=['No of Halogen  (N={})'.format(n)], ascending=False)
                    st.table(ll3)
                    
                    st.markdown('**CFL/Fluorescent**')                    
                    ll4 =pd.DataFrame(frequ.groupby('Governorate')['No of CFL/Fluorescent'].count())
                    ll4['%'] = (100 * ll4['No of CFL/Fluorescent']  / ll4['No of CFL/Fluorescent'].sum()).round(1).astype(str) + '%'
                    n=ll4['No of CFL/Fluorescent'].sum()
                    ll4.rename(columns={'No of CFL/Fluorescent':'No of CFL/Fluorescent  (N={})'.format(n)},inplace=True)
                    ll4=ll4.sort_values(by=['No of CFL/Fluorescent  (N={})'.format(n)], ascending=False)
                    st.table(ll4)
